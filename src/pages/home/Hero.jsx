    ...
    return (
        <div>
           ...
           <div className='relative'>
                ...
                <Link to="/contact" className='absolute bottom-5 right-5 py-2 px-3 rounded bg-primary text-white lg:text-xl shadow-xl hover:bg-bg duration-300'>Contact us</Link>
           </div>
        </div>
    );
};
