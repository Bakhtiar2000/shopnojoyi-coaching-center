...
const PictureBox = ({ photo }) => {
    ...
    return (
        ...
        >
             <img className={`w-[600px] h-[300px] object-cover object-center duration-300 rounded hover:shadow-xl hover:shadow-title/30 ${hoveredId === _id ? 'brightness-50' : ''}`} src={img} alt="" />
